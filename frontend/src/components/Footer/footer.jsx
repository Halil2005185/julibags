        ...
        <footer className="footer-bg w-full text-white">
            <div className="max-w-6xl mx-auto px-6 py-10">
                <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
                    ...
                    {/* Quick Links */}
                    <div className="text-center md:text-right">
                        <h3 className="font-bold text-sm mb-3 text-white/90">روابط سريعة</h3>
                        <ul className="flex flex-col gap-1.5 text-sm text-white/60">
                            ...
                            <li className="hover:text-white transition-colors cursor-pointer">المنتجات</li>
                    ...
                    <div className="text-center md:text-right">
                        ...
                        <div className="flex items-center gap-3">
                            <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/25 flex items-center justify-center transition-all duration-200 hover:scale-110">
                ...
                <div className="mt-8 pt-5 border-t border-white/10 text-center">
                    <p className="text-white/40 text-xs">
                        © 2026 JULI BAGS — جميع الحقوق محفوظة
                    </p>
                </div>
            </div>
        </footer>
